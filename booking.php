...
if(isset($_SESSION['name'])){}
		...
		header("location:There is no proposal to extend to mail/express and superfast trains the flexi-fares currently applicable only to Rajdhani, Shatabdi and Duronto trains,  said Railways Minister Ashwini Vaishnaw
.in1.php");
